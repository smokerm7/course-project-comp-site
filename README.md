...
- API каталога: http://localhost:8080/api/products  
...
**Служебные учётные записи** создаются при первом запуске backend (`DevDataInitializer`). Пароли не публикуются в репозитории — выдаются администратору проекта отдельно.
